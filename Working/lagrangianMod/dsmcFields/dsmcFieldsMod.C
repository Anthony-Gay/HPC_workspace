...
{
    defineTypeNameAndDebug(dsmcFieldsMod, 0);
...
Foam::functionObjects::dsmcFieldsMod::dsmcFieldsMod
(
    const word& name,
    const Time& runTime,
...
bool Foam::functionObjects::dsmcFieldsMod::read(const dictionary& dict)
{
    return true;
}


bool Foam::functionObjects::dsmcFieldsMod::execute()
{
    return true;
}


bool Foam::functionObjects::dsmcFieldsMod::write()
{
    word rhoNMeanName = "rhoN";
    word rhoMMeanName = "rhoM";
    word momentumMeanName = "momentum";
    word linearKEMeanName = "linearKE";
    word internalEMeanName = "internalE";
    word iDofMeanName = "iDof";
    word fDMeanName = "fD";
    ...
    {
        Info<< "Calculating dsmcFieldsMod." << endl;
        ...
        volScalarField::Boundary& pBf = p_Mean.boundaryFieldRef();
        ...
        Info<< "dsmcFieldsMod written." << nl << endl;
    ...
    else
    {
        Info<< "Small value (" << min(mag(rhoNMean))
            ...
            << "Not calculating dsmcFieldsMod to avoid division by zero."
            << endl;
